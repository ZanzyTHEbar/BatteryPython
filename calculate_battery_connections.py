class CalculateBatteryConnections:
    ...
    def __calculate_cell_power(self):
    ...
    def __calculate_series(self):
        ...
        series_power = self.__calculate_cell_power() * series_voltage
        return series_power

    def __calculate_parallel(self):
        parallel_capacity = self.__calculate_cell_power() * self.number_of_cells
...
if __name__ == "__main__":
    battery = CalculateBatteryConnections(10, 10, 215, 1.25, 50)
